...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thiList.add(new Thi("Xuân Diệu", "Ngô Xuân Diệu, là nhà thơ, nhà báo, nhà văn viết truyện ngắn và nhà phê bình văn học người Việt Nam.",R.drawable.xd));
        thiList.add(new Thi("Mạc Ngôn", "Mạc Ngôn là một nhà văn người Trung Quốc xuất thân từ nông dân. Ông đã từng được thế giới biết đến với tác phẩm Cao lương đỏ ",R.drawable.macngonn));
       ...
       // adapter = new MyArrayAdapter(this,thiList);
